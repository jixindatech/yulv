...
func (a *Event) GetAccessList() (map[string]interface{}, error) {
	start := a.Start / 1000
	end := a.End / 1000
...
func (a *Event) GetAccessInfo() (map[string]interface{}, error) {
	start := a.Start / 1000
	end := a.End / 1000
...
func (a *Event) GetRuleList() (map[string]interface{}, error) {
	start := a.Start / 1000
	end := a.End / 1000
	filter := []map[string]interface{}{
		{
	...
	data, err := models.EsSearchList("rule", query, a.Page, a.PageSize)
	if err != nil {
		return nil, err
	}
...
func (a *Event) GetRuleInfo() (map[string]interface{}, error) {
	start := a.Start / 1000
	end := a.End / 1000
